...
// checks if the DeleteResourcesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteResourcesRequest{}
...
func (o DeleteResourcesRequest) ToMap() (map[string]interface{}, error) {
