...
// checks if the EditDomainRatelimitsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditDomainRatelimitsRequest{}
...
func (o EditDomainRatelimitsRequest) ToMap() (map[string]interface{}, error) {
