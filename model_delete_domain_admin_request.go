...
// checks if the DeleteDomainAdminRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteDomainAdminRequest{}
...
func (o DeleteDomainAdminRequest) ToMap() (map[string]interface{}, error) {
