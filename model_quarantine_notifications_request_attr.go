...
// checks if the QuarantineNotificationsRequestAttr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuarantineNotificationsRequestAttr{}
...
func (o *QuarantineNotificationsRequestAttr) GetQuarantineNotification() string {
	if o == nil || IsNil(o.QuarantineNotification) {
		var ret string
		return ret
	}
...
func (o QuarantineNotificationsRequestAttr) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.QuarantineNotification) {
