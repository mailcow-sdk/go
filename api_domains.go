...
type ApiUpdateDomainWideFooterRequest struct {
	ctx context.Context
	ApiService *DomainsAPIService
	updateDomainWideFooterRequest *UpdateDomainWideFooterRequest
}

func (r ApiUpdateDomainWideFooterRequest) UpdateDomainWideFooterRequest(updateDomainWideFooterRequest UpdateDomainWideFooterRequest) ApiUpdateDomainWideFooterRequest {
	r.updateDomainWideFooterRequest = &updateDomainWideFooterRequest
	return r
}

func (r ApiUpdateDomainWideFooterRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
	return r.ApiService.UpdateDomainWideFooterExecute(r)
}

/*
UpdateDomainWideFooter Update domain wide footer

You can update the footer of one or more domains per request.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdateDomainWideFooterRequest
*/
func (a *DomainsAPIService) UpdateDomainWideFooter(ctx context.Context) ApiUpdateDomainWideFooterRequest {
	return ApiUpdateDomainWideFooterRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CreateAlias200Response
func (a *DomainsAPIService) UpdateDomainWideFooterExecute(r ApiUpdateDomainWideFooterRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainsAPIService.UpdateDomainWideFooter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/edit/domain/footer"
	...
	// body params
	localVarPostBody = r.updateDomainWideFooterRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
