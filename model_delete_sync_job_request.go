...
// checks if the DeleteSyncJobRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSyncJobRequest{}
...
func (o DeleteSyncJobRequest) ToMap() (map[string]interface{}, error) {
