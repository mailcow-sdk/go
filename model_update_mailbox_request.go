...
// checks if the UpdateMailboxRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateMailboxRequest{}
...
func (o UpdateMailboxRequest) ToMap() (map[string]interface{}, error) {
