...
// checks if the UpdateAliasRequestAttr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAliasRequestAttr{}
...
func (o *UpdateAliasRequestAttr) GetPublicComment() string {
	if o == nil || IsNil(o.PublicComment) {
		var ret string
		return ret
	}
...
func (o UpdateAliasRequestAttr) ToMap() (map[string]interface{}, error) {
