...
// checks if the DeleteForwardHostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteForwardHostRequest{}
...
func (o DeleteForwardHostRequest) ToMap() (map[string]interface{}, error) {
