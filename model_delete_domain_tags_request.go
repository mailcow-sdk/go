...
// checks if the DeleteDomainTagsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteDomainTagsRequest{}
...
func (o DeleteDomainTagsRequest) ToMap() (map[string]interface{}, error) {
