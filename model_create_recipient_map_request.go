...
// checks if the CreateRecipientMapRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRecipientMapRequest{}
...
func (o *CreateRecipientMapRequest) GetRecipientMapNew() string {
	if o == nil || IsNil(o.RecipientMapNew) {
		var ret string
		return ret
	}
...
func (o *CreateRecipientMapRequest) GetRecipientMapOld() string {
	if o == nil || IsNil(o.RecipientMapOld) {
		var ret string
		return ret
	}
...
func (o CreateRecipientMapRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Active) {
		toSerialize["active"] = o.Active
	}
	if !IsNil(o.RecipientMapNew) {
		toSerialize["recipient_map_new"] = o.RecipientMapNew
	}
	if !IsNil(o.RecipientMapOld) {
