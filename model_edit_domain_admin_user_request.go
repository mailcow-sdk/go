...
// checks if the EditDomainAdminUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditDomainAdminUserRequest{}
...
func (o EditDomainAdminUserRequest) ToMap() (map[string]interface{}, error) {
