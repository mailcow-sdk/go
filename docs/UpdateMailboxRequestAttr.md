...
**Authsource** | Pointer to **string** | Specifies the authentication source for the mailbox. | [optional] 
**Password2** | Pointer to **string** | new mailbox password for confirmation | [optional] 
**Password** | Pointer to **string** | new mailbox password when using &#x60;mailcow&#x60; as the authentication source. | [optional] 
...
`func (o *UpdateMailboxRequestAttr) GetAuthsource() string`

GetAuthsource returns the Authsource field if non-nil, zero value otherwise.

### GetAuthsourceOk

`func (o *UpdateMailboxRequestAttr) GetAuthsourceOk() (*string, bool)`
...
`func (o *UpdateMailboxRequestAttr) SetAuthsource(v string)`

SetAuthsource sets Authsource field to given value.

### HasAuthsource

`func (o *UpdateMailboxRequestAttr) HasAuthsource() bool`
