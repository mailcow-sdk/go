...
**Authsource** | Pointer to **string** | Specifies the authentication source for the mailbox. | [optional] [default to "mailcow"]
**Password2** | Pointer to **string** | mailbox password for confirmation | [optional] 
**Password** | Pointer to **string** | mailbox password when using &#x60;mailcow&#x60; as the authentication source. | [optional] 
...
`func (o *CreateMailboxRequest) GetAuthsource() string`

GetAuthsource returns the Authsource field if non-nil, zero value otherwise.

### GetAuthsourceOk

`func (o *CreateMailboxRequest) GetAuthsourceOk() (*string, bool)`
...
`func (o *CreateMailboxRequest) SetAuthsource(v string)`

SetAuthsource sets Authsource field to given value.

### HasAuthsource

`func (o *CreateMailboxRequest) HasAuthsource() bool`
