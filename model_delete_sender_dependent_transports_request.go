...
// checks if the DeleteSenderDependentTransportsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSenderDependentTransportsRequest{}
...
func (o DeleteSenderDependentTransportsRequest) ToMap() (map[string]interface{}, error) {
