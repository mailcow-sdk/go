...
// checks if the EditDomainAdminACLRequestAttr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditDomainAdminACLRequestAttr{}
...
func (o EditDomainAdminACLRequestAttr) ToMap() (map[string]interface{}, error) {
